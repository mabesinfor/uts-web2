...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">Sistem Manajemen Sekolah</a>
    ...
    <footer class="text-center">
        &copy; 2023 Sistem Manajemen Sekolah, Dibuat dengan Laravel 11. Joko Anwar H1D022999 UTS Pemrograman Web 2.
    </footer>
